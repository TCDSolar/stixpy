...
def stx_estimate_flare_location(cpd_sci, time_range, energy_range=None, plot=False):
    ...
    meta_pixels_sci = create_meta_pixels(
        cpd_sci, time_range=time_range, energy_range=energy_range, flare_location=[0, 0] * u.arcsec, no_shadowing=True
    )
    ...
    results = {"stx": max_stix, "hpc": max_hpc, "sidelobes_ratio": sidelobes_ratio}
