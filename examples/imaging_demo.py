...
cpd = ScienceData.from_fits('/Users/shane/Projects/STIX/git/stix/dbase/demo/imaging/solo_L1_stix-sci-xray-cpd_20200607T213709-20200607T215208_V01_1178428688-49155.fits')


time_range = ['2020-06-07T21:38:45', '2020-06-07T21:43:00']
energy_range = [6, 10]
flare_xy = [-1625, -700] * u.arcsec

vis = create_visibility(cpd, time_range=time_range,
                        energy_range=energy_range, phase_center=[0,0] * u.arcsec, no_shadowing=False)
...
idx = np.searchsorted(cal_vis.isc, isc_10_7)
...
bp_map = vis_to_map(stix_vis, imsize, pixel_size=pixel)
bp_map.meta['rsun_obs'] = cpd.meta['rsun_arc']

max_pixel = np.argwhere(bp_map.data == bp_map.data.max())*u.pixel
...
vis = create_visibility(cpd, time_range=time_range,
                        energy_range=energy_range, phase_center=[max_hpc.Tx, max_hpc.Ty], no_shadowing=False)
